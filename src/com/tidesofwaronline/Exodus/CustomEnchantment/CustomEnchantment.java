...
public class CustomEnchantment {
	...
	public static CustomEnchantment POISON = new Poison();
	public static CustomEnchantment FREEZE = new Freeze();
	public static CustomEnchantment FIREAURA = new FireAura();
	...
	public String display() {
		if (ce != null) {
			...
			return WordUtils.capitalizeFully(e.getName()) + " " + RomanNumeral.convertToRoman(level);
		} else {
			return null;
		}
	}
	...
	public Enchantment getEnchantment() {
		if (e != null) return this.e;
		else return null;
	}

	public CustomEnchantment getCustomEnchantment() {
		if (ce != null) return this.ce;
		else return null;
	}
