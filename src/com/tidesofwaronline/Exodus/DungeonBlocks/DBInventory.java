...
public class DBInventory {
	...
	public DBInventory () {
		...
		inv.setItem(29, new DBInventoryIcon(RedstoneSwitch.class));
		
		//Trigger Blocks
		inv.setItem(3, new DBInventoryIcon(ClickTrigger.class));
		...
		inv.setItem(24, new DBInventoryIcon(InventoryEditor.class));
